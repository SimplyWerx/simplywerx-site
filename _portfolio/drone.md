...
subtitle: An all-in-one controller for autonomous indoor performance drones
...
---
We designed and built an all-in-one flight controller tailored for autonomous and scripted miniature performance drones. The system integrates IMU sensors, an ARM-based microprocessor, an NRF 2.4 GHz radio link, and BLHeli-based ESCs with MOSFET drivers for brushless motors.
